...
function Invoke-Before {
    ...
    $script:pkg_version=getLatestRelease("mozilla/geckodriver")
    $script:pkg_source="https://github.com/mozilla/geckodriver/releases/download/$pkg_version/geckodriver-v$pkg_version-win64.zip"
